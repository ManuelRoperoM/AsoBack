...
<html lang="es">
  ...
  <body>
    <div class="container">
      <div class="header">
        <h1>Tu cuenta de AsoMunicipios</h1>
      </div>

      <div class="content">
        <h2>Hola {{nombre}},</h2>
        <p>
          Ya tienes tu cuenta de AsoMunicipos, se ha generado una nueva contraseña temporal para tu cuenta. Por motivos de seguridad, te recomendamos cambiarla una vez que inicies sesión.
        </p>
